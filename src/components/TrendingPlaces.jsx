const TrendingPlaces = () => {
  ...
  return (
    <section className="md:mx-[15%] mx-[3%] py-8">
      ...
      <div>
        ...
        {/* 3 column grid here */}
        <div className="grid lg:grid-cols-3 gap-4 lg:mt-8 mt-4">
          {places.slice(2).map((place, index) => (
            <div className="relative hover:shadow-lg" key={index}>
              <h3 className="text-2xl rounded-lg absolute inset-0 text-white flex items-start justify-start bg-black bg-opacity-50 p-4">
                {place.name}
              </h3>
              <img
